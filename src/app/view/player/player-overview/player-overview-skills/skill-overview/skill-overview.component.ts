...
import { getLevelForXp, getXpRequiredForLevel, skillNames, Skills } from '../../../../../shared/rs/rs.constants';
...
export class SkillOverviewComponent implements OnInit, OnChanges {
    ...
    private calculateValues(skill: PlayerSkill): void {
        ...
        this._currentLevel = getLevelForXp(skill.xp, elite);
        ...
        const currentLevelXp = getXpRequiredForLevel(this._currentLevel, elite);
